...
export const Contactpage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send('service_a1wo2tj', 'template_lqt7e2v', templateParams, 'D4XeibReFY-9dz4TY')
      .then((response) => {
      ...
      <div className="mt-20">
        <section className="bg-white">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            {successMessage && <p className="text-center text-blue-600 font-medium mb-4">{successMessage}</p>}
            {errorMessage && <p className="text-center text-red-600 font-medium mb-4">{errorMessage}</p>}
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                <label htmlFor="message" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-300">
                  Message
                </label>
                <textarea
                  id="message"
